...
const RightSellingOption = () => {
  return (
    <SectionWrapper className="bg-estate-black-1 lg:bg-estate-grey-6 relative grid grid-cols-12 mt-20">
      <div className="mt-[550px] lg:mt-[unset] col-start-1 col-span-12 lg:col-start-6 lg:col-span-7 relative z-10">
        <div className="mt-5 h-[700px] grid grid-cols-12 grid-rows-12 gap-5">
